...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h3 style="text-align:centre"><span style="color:#4cd137;">Updates made successfully</h3>
      ...
      <footer style="color:#0984e3; padding:50px;">
        <p>For more details, contact us:</p><br>
        <p>Email us at: bloodonation@gmail.com</p><br>
